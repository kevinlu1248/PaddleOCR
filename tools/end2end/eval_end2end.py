...
def e2e_eval(gt_dir, res_dir, ignore_blank=False):
    """
    Description: This function evaluates the end-to-end performance of the OCR system.

    Args:
        gt_dir (str): The directory containing the ground truth files.
        res_dir (str): The directory containing the result files.
        ignore_blank (bool, optional): Whether to ignore blank characters. Defaults to False.
