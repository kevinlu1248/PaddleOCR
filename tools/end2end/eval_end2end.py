...
def calculate_edit_distance(dts, gts, iou_thresh):
...
def calculate_iou(dt_match, dts, ed_sum, dt_count, gt_match, ignore_masks, gts, num_gt_chars, gt_count):
    # unmatched dt
...
def read_gt_dt_lines(hit, dt_count, gt_count, ed_sum, val_names, num_gt_chars):
    eps = 1e-9
