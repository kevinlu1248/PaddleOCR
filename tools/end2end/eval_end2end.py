...
def e2e_eval(gt_dir, res_dir, ignore_blank=False):
    ...
    for i, val_name in enumerate(val_names):
        ...
        ed_sum, dt_count, num_gt_chars, gt_count, hit = match_results(gts, dts, iou_thresh, gt_match, dt_match, ignore_blank, ignore_masks, ed_sum, num_gt_chars, hit, gt_count, dt_count)
...
def match_results(gts, dts, iou_thresh, gt_match, dt_match, ignore_blank, ignore_masks, ed_sum, num_gt_chars, hit, gt_count, dt_count):
    ...
    for gt_dt_pair in sorted_gt_dt_pairs:
        ...
        if gt_match[index_gt] == False and dt_match[index_dt] == False:
            ...
            if ignore_masks[index_gt] == '0':
                ...
                gt_count += 1
                dt_count += 1
    return ed_sum, dt_count, num_gt_chars, gt_count, hit
